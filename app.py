...
SERVERS = {
    ...
    "BD":  "https://clientbp.ppmainecoonghj.com/UpdateSocialBasicInfo",
    "SG":  "https://clientbp.ppmainecoonghj.com/UpdateSocialBasicInfo",
    "BR":  "https://client.us.freefiremobile.com/UpdateSocialBasicInfo",
    "US":  "https://client.us.freefiremobile.com/UpdateSocialBasicInfo",
    "EU":  "https://clientbp.ppmainecoonghj.com/UpdateSocialBasicInfo",
}
...
def combined_bio_upload():
    ...
    response_data = {
        "Credit": "@kuchupuchu04",
        "Join For More": "Telegram: @nxcofficial",
...
<body>
    <div class="container">
     ...
     -d "region=IND"</pre>
        ...
        <div class="footer">
            Owner: Kazu<br>
            Telegram: <a href="https://t.me/kuchupuchu04" target="_blank">@kuchupuchu04</a><br>
        </div>
    </div>
            ...
            try {
                ...
                if(d.code === 200) {
                    showResult('success', 'SUCCESS', `
                        ...
                        <div class="credit">Credit: ${d.Credit || '@kuchupuchu04'}</div>
                    `);
    ...
    <div class="main">
        <div class="glass-panel">
            ...
            <div class="footer">
                Owner: kazu<br>
                Telegram: <a href="https://t.me/kuchupuchu04" target="_blank">@kuchupuchu04</a><br>
                Telegram Channel: <a href="https://t.me/nxcofficial">T10 NXC FILES</a>
            </div>
        </div>
    </div>
</body>
